        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="pt-3 pt-md-5 mt-5 col-12 col-md-8">
              ...
              <div className={`my-4 ${style.inpWidth}`}>
                <label
                  htmlFor="email"
                  className="d-block mb-1 fw-bold shamel fs18"
                >
                  {t("emailTwo")}
                </label>
                <input
